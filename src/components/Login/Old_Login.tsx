...
//2 LoginReduxForm   снабжает (1 LoginForm)чем: "handleSubmit"-ом из  Redux-form  и уникальным именем 
//3 Login снабжает (2 LoginReduxForm) чем: снабжает к-ту "onSubmit"-ом из  Redux-form 
//4 connect снабжает (3 Login) чем: mapStateToProps-ом и ф-цией{ login }
